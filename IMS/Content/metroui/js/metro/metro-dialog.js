(function($) {
    ...
    $.Dialog.close = function() {
       ...
       // alert(_overlay.children(".window").index())
        
        
       // alert(_dialog.html())
        //alert($("body .window-overlay:first-child").html())
       
        var index_ = $("body").find(".window-overlay").length
       
        $("body").find(".window-overlay").slice(index_ - 1).fadeOut(function () {
      
            $("body").find(".window-overlay").slice(index_ - 1).remove();
